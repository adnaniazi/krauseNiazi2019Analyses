...
# get moves in the tail for data basecalled using standard model
dna_kr_st_mt =
  get_data(release_version = data_release_version,
           file_name = 'dna-krause-lsk108_109-standard_basecalling-moves_in_tail-two_replicates-with_filepaths.csv')

# get moves in the tail for data basecalled using flipflop model
dna_kr_ff_mt =
  get_data(release_version = data_release_version,
           file_name = 'dna-krause-lsk108_109-flipflop_basecalling-moves_in_tail-two_replicates-with_filepaths.csv')
