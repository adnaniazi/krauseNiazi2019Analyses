...
In our DNA algorithms, we have set a threshold of 0.3 for poly(T) reads; potential poly(T) tail should have a mean value below this threshold in the normalized signal. Similarly, we have set a threshold of 0.6 for Poly(A) reads; potential poly(A) tail should have a mean value below this threshold in the normalized signal. The analysis below shows that our thresholds are conservative and are above the maximum expected poly(A)/(T) levels.
...
maximum_expected_nomrmalized_AAAAAA_level  <- 
  ((mean_AAAAAA - 2 * sd_AAAAAA) - mean_all_kmers) / sd_all_kmers

maximum_expected_nomrmalized_TTTTTT_level  <- 
  ((mean_TTTTTT - 2 * sd_TTTTTT) - mean_all_kmers) / sd_all_kmers

cat(paste0("Maximum expected nomrmalized AAAAAA level: ", 
           abs(maximum_expected_nomrmalized_AAAAAA_level), '\n'))

cat(paste0("Maximum expected nomrmalized TTTTTT level: ", 
           abs(maximum_expected_nomrmalized_TTTTTT_level), '\n'))
